...
public class ApiService {
    ...
    public Map<String, StockPriceResponse> getQuotes(String stockSymbol, String interval) {
        ...
        try {
            return webClient.get()
                    ...
                    .bodyToMono(new ParameterizedTypeReference<Map<String, StockPriceResponse>>() {})
                    .block();
        } catch (WebClientResponseException e) {
            System.err.println("HTTP Status: " + e.getRawStatusCode() + ", Body: " + e.getResponseBodyAsString());
            throw e;
    ...
    public StockPriceResponse getQuote(String stockSymbol, String interval) {
        String[] intervals = {"1min", "5min", "15min", "30min", "45min", "1h", "2h", "4h", "1day", "1week", "1month"};
        String requestInterval = (!Arrays.asList(intervals).contains(interval)) ? "1day" : interval;
